...
class Dem2Stl:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Dem2Stl', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/dem2stl/icon.png'
        self.add_action(
            icon_path,
    ...
    def run(self):
        ...
        if layers:
            for layer in layers:
                ...
                QgsProject.instance().layerTreeRoot().findLayer(layer).isVisibly():
                    raster = True
                    break
            if raster and self.window:
                QMessageBox.information(self.iface.mainWindow(
                ), "DEM2STL", self.tr("A visible raster layer loaded"))
