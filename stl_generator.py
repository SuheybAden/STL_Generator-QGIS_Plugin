...
class STLGenerator:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&STL Generator')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('STL Generator', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/stl_generator/icon.png'
        self.add_action(
            icon_path,
    ...
    def run(self):
        ...
        if self.first_start:
            ...
            self.dlg = STLGeneratorDialog()

        layers = self.iface.mapCanvas().layers()

        # QMessageBox.information(self.iface.mainWindow(),
        # 		"STL Generator", self.tr(str(layers)))
        ...
        if layers:
            ...
            if not available_raster:
                QMessageBox.information(self.iface.mainWindow(
                ), "STL Generator", self.tr("No visible raster layer loaded."))
                return
        elif not layers:
            QMessageBox.information(self.iface.mainWindow(
            ), "STL Generator", self.tr("No visible raster layer loaded"))
